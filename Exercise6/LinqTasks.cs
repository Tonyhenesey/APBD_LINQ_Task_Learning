...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static int Task3()
        {
            ...
            int methodSyntax = Emps.Max(e => e.Salary);
        ...
        public static IEnumerable<Emp> Task4()
        {
            ...
            var syntax = Emps.Where(s => s.Salary.Equals(maxSalary));
        ...
        {
            var syntax=Emps.Any(e=>e.Job.Equals("Backend programmer"));
            bool result = syntax;
            return result;
        }
        ...
        {
            var syntax = Emps.OrderByDescending(h => h.HireDate).First();
            Emp result = syntax;
            return result;
        }
        ...
        public static IEnumerable<object> Task11()
        {
            var linq = Emps
                ...
                .Select(g => new 
                {
                    name = Depts.First(dept => dept.Deptno == g.Key).Dname,
                    numOfEmployees = g.Count()
                });

            IEnumerable<object> result = linq;
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Emps.WithDirectSubordinates();
            return result;
        }
    ...
    {
        public static IEnumerable<Emp> WithDirectSubordinates(this IEnumerable<Emp> emps)
        {
            return emps.Where(emp => emps.Any(sub => sub.Mgr != null && sub.Mgr.Empno == emp.Empno))
